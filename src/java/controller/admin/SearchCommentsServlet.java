...
public class SearchCommentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!productID_raw.matches("\\d+")) {
                request.setAttribute("error", "Vui lòng nhập ProductID là Number!");
            } else {
            ...
            request.getRequestDispatcher("searchcomments.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
