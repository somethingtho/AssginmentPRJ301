...
public class TabletServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TabletServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TabletServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("titlePage", "Tablet");
        ...
        request.setAttribute("cate", "Tablet");
        Vector<Products> listAllType = daoProducts.getAllTablet();
        String type = "tablet";
        Vector<Suppliers> listAllSuppliersType = daoSuppliers.getAllSuppliersTablet();
        ...
        Vector<Products> vector = daoProducts.getProductsBySuppliers(sid, "tablet", orderby_raw, from, to);
