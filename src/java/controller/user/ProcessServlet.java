...
public class ProcessServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Vector<Shippers> listShippers = daoShippers.getAllShippers();
        ...
        try{
            ...
            Products p=daoProducts.getProductByID(id);
            ...
            if(num==-1&&(cart.getQuantityById(id)<=1)){
                ...
                double price=p.getUnitPrice()*1.2;
    ...
    throws ServletException, IOException {
        ...
        Vector<Products> list = daoProducts.getAllProducts();
        Vector<ProductInfo> listInfo = daoProductInfo.getAllProductInfo();
        Cookie[] arr=request.getCookies();
        String txt="";
        if(arr!=null){
            for(Cookie o:arr){
