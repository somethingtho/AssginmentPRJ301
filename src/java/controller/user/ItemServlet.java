...
public class ItemServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(cate.getCategoryName().equalsIgnoreCase("SmartPhone")) request.setAttribute("type", "mobile");
            if(cate.getCategoryName().equalsIgnoreCase("Laptop")) request.setAttribute("type", "laptop");
            if(cate.getCategoryName().equalsIgnoreCase("Tablet")) request.setAttribute("type", "tablet");
