                    ...
                    <table style="width: 99rem;" class="table">
                        ...
                        <c:forEach items="${requestScope.ordersByCustomerID}" var="order">
                            ...
                            <c:forEach var="orderDetail" items="${order.orderDetails}">
                                <tr>
                                    <td style="border-top: none; text-align: center;padding-right: 80px;"><a href="orderdetail?oid=${order.orderID}"><c:if test="${count ==0}">${order.orderID}</c:if></a></td>
                                        <c:set var="count" value="${count+1}"  scope="page"></c:set>
                                    <td style="display: flex;"><a href="item?pid=${orderDetail.product.productID}"><img style="width: 50px;" src="data:image/jpg;base64,${orderDetail.product.base64Image}"/>
                                            <div>
                                                <a href="item?pid=${orderDetail.product.productID}">${orderDetail.product.productName}</a>
