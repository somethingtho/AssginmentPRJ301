<%-- 
    Document   : categories
    Created on : Feb 8, 2023, 7:44:15 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <link href="dist/css/categories.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row el-element-overlay">
                                ...
                                <div class="card">
                                    <div class="el-card-item">
                                                ...
                                                <ul class="list-style-none el-info">
                                                    <li class="el-item">
                                                        <a
                                                            ...
                                                            href="assets/images/users/df.webp"
                                        ...
                                        <div
                                            ...
                                            <h4>Tổng số sản phẩm: ${c.number}</h4>
                                            <button
                                                style="
                                                border: none;
                                                margin-top: 1rem;
                                                ...
                                                "
                                                >
                                                <a style="color: white" href="${pageContext.request.contextPath}/admin/updatecategory?cid=${c.categoryID}">Chỉnh sửa</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="${pageContext.request.contextPath}/admin/addcategory">
                                <button class="button"><p class="button_text">Thêm mới</p>
                                    <div class="icon-1">
                    ...
                    <div class="card ">
                        <h5  style="margin-top: 20px" class="card-title">Biểu đồ số sản phẩm của từng danh mục</h5>
                        <div style="display: grid; place-items: center">
                            <div id="chart3" style="width:100%;max-width:400px;"></div>
        ...
        <script>
            ...
            <c:forEach items="${requestScope.listAllCate}" var="c">
            dataa.push("${fn:escapeXml(c.categoryName)}");
            datab.push(${c.number});
            </c:forEach>
            console.log(dataa);
            console.log(datab);
