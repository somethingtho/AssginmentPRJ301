<%-- 
    Document   : formupsup
    Created on : Feb 8, 2023, 9:27:56 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>Cập nhật thương hiệu(${requestScope.supplier.companyName})</title>
        <!-- Favicon icon -->
        <link
            rel="icon"
            type="image/png"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="updatesupplier" method="POST">
                                <input type="hidden" value="${requestScope.supplier.supplierID}" name="supplierID">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input
                                                    ...
                                                    name="companyName"
                                                    placeholder="Input"
                                                    value="${requestScope.supplier.companyName}"
                                                    />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input
                                                    ...
                                                    name="email"
                                                    placeholder="Input"
                                                    value="${requestScope.supplier.email}"
                                                    />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input
                                                    ...
                                                    name="phoneNumber"
                                                    placeholder="Input"
                                                    value="${requestScope.supplier.phone}"
                                                    />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input
                                                    ...
                                                    name="homePage"
                                                    placeholder="Input"
                                                    value="${requestScope.supplier.homePage}"
                                                    />
                                            </div>
                                        </div>
