<%-- 
    Document   : shippers
    Created on : Feb 10, 2023, 1:06:44 AM
    Author     : ADMIN
--%>
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row el-element-overlay">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0">Danh sách các đơn vị vận chuyển</h5>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody class="customtable">
                                        <c:forEach items="${requestScope.listAllShippers}" var="shipper">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${shipper.status}">Đang hoạt động</c:when>
                                                        <c:otherwise>Ngưng hoạt động</c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <th><a href="${pageContext.request.contextPath}/admin/profile?type=ship&id=${shipper.shipperID}">Hồ sơ</a></th>
                                            </tr>
                                        </c:forEach>
