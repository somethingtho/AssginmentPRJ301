<%-- 
    Document   : indexforsup
    Created on : Feb 9, 2023, 1:39:07 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <title>HomePage for Suppliers</title>
        <!-- Favicon icon -->
                        ...
                        <ul class="navbar-nav float-end">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-account me-1 ms-1"></i> Hồ sơ của
                                        tôi</a>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-settings me-1 ms-1"></i> Đổi mật
                                        khẩu</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="logoutadmin"><i class="fa fa-power-off me-1 ms-1"></i> Đăng
                                        xuất</a>
                                    <div class="dropdown-divider"></div>
                                    <div class="ps-4 p-10">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <h5 class="mb-0 mt-1">${requestScope.totalShippersBySupplier}/${requestScope.totalShippers}</h5>
                                                ...
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        ...
                                                        <h5 class="mb-0 mt-1">${requestScope.totalMoney}</h5>
                                                ...
                                                <div class="col-6 mt-3">
                                                    <div class="bg-dark p-10 text-white text-center">
                                                        <i class="mdi mdi-comment-account fs-3 mb-1 font-16"></i>
                                                        <h5 class="mb-0 mt-1">${requestScope.totalReview}</h5>
                                                        <small class="font-light">Total Review</small>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="comment-widgets scrollable">
                                    <!-- Comment Row -->
                                    <c:forEach items="${requestScope.newReviews}" var="news">
                                        <div class="d-flex flex-row comment-row mt-0">
                                            <div class="p-2">
                                                <img src="data:image/jpg;base64,${news.cus.base64Image}" alt="user" width="50" class="rounded-circle" />
                                            </div>
                                            <div class="comment-text w-100">
                                                <h6 class="font-medium">${news.cus.customerName}</h6>
                                                <span class="mb-3 d-block">${news.contentSend}<br>
                                                    (${news.rate} <i class="fas fa-star" style="color: gold;"></i>)
                                                </span>
                                                <div class="comment-footer">
                                                    <span class="text-muted float-end">${news.dateRate}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </c:forEach>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody class="customtable">
                                            <c:forEach items="${requestScope.listCustomerFr}" var="fr">
                                                <tr>
                                                    <td>${fr.customerID}</td>
                                                    <td>${fr.customerName}</td>
                                                    <td>${fr.email}</td>
                                                    <td>${fr.phone}</td>
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${fr.gender}">Nam</c:when>
