<%-- 
    Document   : formupcate
    Created on : Feb 8, 2023, 9:26:50 PM
    Author     : ADMIN
--%>
                        ...
                        <ul id="sidebarnav" class="pt-4">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="${pageContext.request.contextPath}/admin/listallcategoriesl" class="sidebar-link"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="updatecategory" method="POST">
                                <input type="hidden" value="${requestScope.category.categoryID}" name="categoryID">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 style="color: red" class="card-title">${requestScope.message}</h3>
                                        ...
                                        <div class="form-group row">
                                            <p style="color: red;">Vui lòng không nhập những thông tin đã có ở bảng trên!</p>
                                            <label
                                                for="catename"
